//
// QCode.cs - Copyright (c) 2006-2025 Josh Dersch (derschjo@gmail.com)
//
...
namespace PERQemu.Debugger
{
    ...
    public static class QCodeHelper
    {
        ...
        /// <summary>
        /// PNX 5 C-Codes -- a rough guess based on pulling strings out of the
        /// assembler binary.  THANKS ICL.  REAL HELPFUL KEEPING YOUR INSTRUCTION
        /// SET TOP SECRET.  NO documentation?  SERIOUSLY?  What follows may be
        /// wrong and two-byte ops (if any) are sure to be off/unknown.
        /// </summary>
        static QCode[] _cCodes =
        {
            new QCode(0, "halt"),
            new QCode(1, "ilp1"),
            new QCode(2, "ilp2"),
            ...
            new QCode(43, "lga"),
            new QCode(44, "return"),
            new QCode(45, "return2"),
            new QCode(46, "return4"),
            new QCode(47, "indxjump"),
            new QCode(48, "sr0"),
            new QCode(49, "sr1"),
            new QCode(50, "sr2"),
            new QCode(51, "sr3"),
            ...
            new QCode(155, "li"),
            new QCode(156, "hli"),
            // 157..160 undefined           -- all have microcode
            new QCode(161, "llos"),
            new QCode(162, "llol"),
            new QCode(163, "lhlos"),
            new QCode(164, "lhlol"),
            ...
            new QCode(177, "uge"),
            new QCode(178, "ugt"),
            // 179..181 undefined           -- all have microcode
            new QCode(182, "ipop"),
            new QCode(183, "oasra"),
            new QCode(184, "lhui"),
            new QCode(185, "cvba"),
            // 186..187 undefined           -- both are defined
            new QCode(188, "deposit"),
            new QCode(189, "field"),
            // 190..191 undefined
            new QCode(192, "exch"),
            new QCode(193, "dupl"),
            ...
            new QCode(207, "atr3"),
            // 208..209 undefined
            new QCode(210, "pfield"),
            new QCode(211, "pdeposit"),
            // 212..232 undefined           -- 216..227 are defined
            new QCode(233, "umenter"),
            new QCode(234, "wcs"),
            // 235..243 undefined           -- all have microcode
            new QCode(244, "rop0"),
            new QCode(245, "rop1"),
            new QCode(246, "sys"),
            new QCode(247, "sio"),
            new QCode(248, "sps"),
            new QCode(249, "drawline"),
            new QCode(250, "rasterop"),
            new QCode(251, "drawbyte"),
            new QCode(252, "trapp"),
            new QCode(253, "null"),
            // 254 undefined                -- has code
            new QCode(255, "refill")        // Implicit (hardware)
        };
